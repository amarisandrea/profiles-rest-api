...
class HelloApiView(APIView):
    ...
    def get( self, request, format=None):
        ...
        an_apiview=[
        'Uses HTTP method as functions (get, post,patcha,put,delete)',
    ...
    def put(self, request, pk=None):
        """Handle uppdating an object"""
        return Response({'method': 'PUT'})

    def patch(self, request, pk=None):
        """Handle a partial uppdating an object"""
...
class HelloViewSet(viewsets.ViewSet):
    """Test API ViewSet"""
    name = serializers.HelloSerializer
    def list (self, request):
        a_viewset=[
        'Uses actions(list,create,retrive, update, partial_update)',
        'Automatically maps to URLs using Routers',
        'Provides more functionaliti with less code',
        ]
    ...
    def create(self,request):
        ...
        if serializer.is_valid():
            ...
            return Response(
            serializer.errors,
            dtatus=status.HTTP_400_BAD_REQUEST
            )
    ...
    def destroy( self, request, pk=None):
        ...
        return Respose({'http_method':'DELETE'})
